...
def preliminary_ir(ast_slice: Tensor) -> list[IR]:
    ...
    for parent in control_flow["LOAD"]:
        indexing_ir(parent, kernel, dimensions, tensor_pointers, const_pointers, parent._memory.stride)
    ...
    kernel.ir.append(temp_op)
    indexing_store_ir(ast_slice, kernel, dimensions, tensor_pointers, const_pointers, store_stride)
